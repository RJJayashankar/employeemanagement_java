...
class Print_Data1 implements ActionListener{
    JFrame f;
    ...
    Print_Data1(String e_id){
        try{
            ...
            while(rs.next()){
                ...
                education = rs.getString("qualification");
        ...
        id9.setLayout(null);
        try {
            f.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\Bhara\\OneDrive\\Documents\\java pics\\blank.jpg")))));
        } catch (IOException e) {
            e.printStackTrace();
        }
